...
//         history.push(`/course-details/${id}`); // Replace with the desired path and ID parameter
//     };
...
//   return (
//     <>
//         <div key={index} className="courses" onClick={() => handleButtonClick(123)}>
//           <img src= {source} alt="" />
...
//               ))}
//               <span class="review">({course.reviews})</span>
//             </div>
//           </div>
